...
Contains 9 high-resolution presentation panels (`poster_panel_01.png` through `poster_panel_09.png`) prepared for display stands, highlighting:
- The hazardous reconnaissance problem statement
- Multi-MCU distributed electronics topology
- Environmental gas and obstacle sonar capabilities
- Ground station telemetry dashboard and camera operations
